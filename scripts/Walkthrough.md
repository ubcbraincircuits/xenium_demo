...
Open single_file_demo.R script and follow the below steps:
...
> **NOTE:** Order of loading libraries are relevant. If multiple libraries have functions with the same name, 
the overloaded function would default to the last loaded library. 
>
> To specify a certain library use syntax:  package_name::function_name(). 
>
> You can view package being used for a function name using: find("function_name")*
